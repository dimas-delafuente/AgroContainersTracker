...
{
    public class UpdateInputCommand : IRequest<bool>
    {
    ...
    public static class UpdateInputCommandExtensions
    {
        public static Input ToDomain(this UpdateInputCommand command)
            => new Input
            {
